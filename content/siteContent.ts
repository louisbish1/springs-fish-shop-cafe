...
export const siteContent = {
  ...
  home: {
    ...
    location: {
      ...
      noteBody: 'Tuesday to Sunday, 9:00am to 4:00pm. Monday closed.',
      mapHeading: 'Find Us',
    ...
    columns: [
      {
        heading: 'Contact',
        links: [
          { label: '01903-495-284', href: 'tel:01903495284' },
